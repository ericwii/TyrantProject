...
void Animation::InitModel(const string& aTextureFileName, const Vector3<float>& aPosition, const Vector2<float> aSize)
{
	Model* model = ModelLoader::LoadRectangle(aSize, eEffectType::Animated, aTextureFileName);
